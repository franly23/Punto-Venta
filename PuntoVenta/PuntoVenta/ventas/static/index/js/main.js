...
function editarProduct('codigo_barras', 'descripcion', 'imagen', 'categoria', 'disponibilidad','cantidad') {
  document.getElementById("codigo_barras_editar").value = codigo_barras;
  document.getElementById("descripcion_editar").value = descripcion;
...
function editarPersonal(id, nombre, telefono, cuit_cuil, email, direccion) {
  document.getElementById("id_personal_editar").value = id;
  document.getElementById("nombre_editar").value = nombre;
  document.getElementById("telefono_editar").value = telefono;
  document.getElementById("cuit_cuil_editar").value = cuit_cuil;
...
function editarProducto(id, codigo, descripcion, categorias_id, precio, cantidad) {
  document.getElementById("id_producto_editar").value = id;
  document.getElementById("codigo_editar").value = codigo;
  document.getElementById("descripcion_editar").value = descripcion;
  document.getElementById("categorias_editar").value = categorias_id;
  document.getElementById("precio_editar").value = precio.replace(',','.');
  document.getElementById("cantidad_editar").value = cantidad;
}
